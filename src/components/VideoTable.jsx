    ...
    <div className="video-table-container">
      ...
      <div className="table-wrapper">
        <table className="video-table">
          <thead>
            <tr>
              <th className="th-thumbnail" title="영상의 미리보기 이미지">썸네일</th>
              <th
                className="th-title sortable"
                onClick={() => handleSort('title')}
                title="영상의 제목 (클릭하여 정렬)"
              >
              ...
              <th
                ...
                title="영상의 재생 시간 (쇼츠: 3분 미만, 롱폼: 3분 이상) (클릭하여 정렬)"
              >
              ...
              <th
                ...
                title="해당 영상의 조회수가 채널 전체 조회수에서 차지하는 비율 (%) (클릭하여 정렬)"
              >
              ...
              <th
                ...
                title="구독자 대비 조회수 비율 (조회수 ÷ 구독자 수) (클릭하여 정렬)"
              >
